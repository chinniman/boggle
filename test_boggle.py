...
class TestBoogle(unittest.TestCase):
    ...
    def test_grid_size_is_width_times_height(self):
        """
        Test is to ensure that he total size of the grid
    ...
    def test_grid_coordinates(self):
        """
        Test to ensure all of the coordinates
        insode of the grid can be accessed
        """
    ...
    def test_neightbours_of_a_position(self):
        """
    ...
    def test_search_grid_for_words(self):
        ...
        threeLetterWod = "ABC"
        notThereWord = "EEE"
        dictionary = [twoLetterWord,threeLetterWod,notThereWord]
        
        foundWords = boggle.search(grid, dictionary)
        self.assertTrue(twoLetterWord in foundWords)
        self.assertTrue(threeLetterWod in foundWords)
        self.assertTrue(notThereWord not in foundWords)
        
    def test_load_dictionary(self):
        """
        Test that the "get_dictionary" function returns a dicionary
        that has a length greater than 0
        """
        dicionary = boggle.get_dictionary("words.txt")
...
# twoLetterWord = boggle.path_to_word(grid,[(0,0),(1,1)])
# print(twoLetterWord)
# grid = boggle.make_grid(3,3)            
#  print(len(grid))
# print(boggle.all_grid_neighbours(grid))
#print(list(grid))
# grid = boggle.make_grid(3,3)
# neighbours = boggle.all_grid_neighbours(grid)
# for pos in grid:
